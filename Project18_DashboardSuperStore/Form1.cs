...
namespace Project18_DashboardSuperStore
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            sqlConnection.Open();
            SqlCommand command5 = new SqlCommand("Select top(5) Country, Count(*) From superstore Group By Country order by COUNT(*) desc", sqlConnection);
            ...
            sqlConnection.Open();
            SqlCommand command6 = new SqlCommand("Select top(3) Country, sum(Quantity) From superstore Group By Country by sum(quantity) desc", sqlConnection);
