...
namespace Project16_MailRegister
{
    public partial class Form1 : Form
    {
        ...
        private void btnRegister_Click(object sender, EventArgs e)
        {
            ...
            MailboxAddress miailboxAddressFrom = new MailboxAddress("AdminRegister", "mail adresi");
            mimeMessage.From.Add(miailboxAddressFrom);
            ...
            MessageBox.Show("Mail adresinizi doğrulama kodu gönderilmiştir.");
