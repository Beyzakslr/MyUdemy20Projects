...
namespace Project1_AdonetCustomer
{
    public partial class FrmCustomer : Form
    {
        ...
        {
            sqlConnection.Open();
            SqlCommand command = new SqlCommand("Insert Into TblCustomer ( CustomerName,CustomerSurname," +
                "CustomerCity,CustomerBalance,CustomerStatus) values " +
                "(@customerName,@customerSurname,@customerCity,@customerBalance,@customerStatus)", sqlConnection);
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand command = new SqlCommand("Update TblCustomer Set CustomerName=@customerName," +
                ...
                "CustomerBalance=@customerBalance,CustomerStatus=@customerStatus " +
